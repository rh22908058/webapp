<template>
  <div class="player" v-show="currentIndex!=-1">
      ...
      <div class="normal-player" v-show="fullScreen">
          ...
          <div class="image-wrapper" :class="cdRotate" :style="bgStyle">
          </div>
          <div class="lyric">
          ...
          <div class="operators-wrapper">
              ...
              <div class="icon i-middle">
                <i @click="togglePlay" :class="toggleImagePlay"></i>
              </div>
      ...
      <div class="mini-player" v-show="!fullScreen">
          <div class="img-wrapper" @click="toggleNormal">
              <img class="img" :class="cdRotate" :src="currentSong.image" width="42" height="42"/>
          </div>
          <div class="content">
